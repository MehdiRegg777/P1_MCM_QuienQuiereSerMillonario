...
<html>
    ...
    <body class="fondo">
        ...
        <div class="container">    
            ...
            <a class="play-button" href="game.php?nuevo_juego=true">Jugar</a>
        ...
        <div class="languagesimages">
            ...
            <img src="imgs/catalunya.jpeg" alt="Imagen de la bandera de Catalunya">
            <img src="imgs/uk.webp" alt="Imagen de la bandera del Reino Unido">
        </div>
